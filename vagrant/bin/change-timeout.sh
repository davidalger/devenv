...
for arg in "$@"; do
    case $arg in
        ...
        --help)
            ...
            echo ""
            echo "    Change MySQL wait_timeout, PHP mysql.connect_timeout and default_socket_timeout, and Nginx"
            echo "    proxy_read_timeout values. Useful for facilitating long-running PHP debugging sessions."
            echo ""
